...
public class MainActivity extends AppCompatActivity implements SampleRender.Renderer {
    ...
    //AR objeleri properties, rendererlar vs.
...
//        setContentView(R.layout.activity_main);
        ...
        girisButonu.setOnClickListener(view -> onButtonListener());

    }

    /**
     * TODO: user'i verify etmek gerekli
     */
    private void onButtonListener(){

        //do this if user is verified.
...
//            System.out.println(resultDisplayStr);
            ...
            //set content view to display ar objects
            displayARTables();
    ...
    /**
     * AR Tablolarini render'lamak ve display etmek icin
     * yazdigimiz fonksiyon.
     */
    private void displayARTables() {
        setContentView(R.layout.ar_objects);
